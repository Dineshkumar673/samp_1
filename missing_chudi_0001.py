...
dest='/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset/Datasets/Absdiff_base_dir/Arya_chudi_missing/Arya_chudidhar_0001/'
...
print("$$$Done With Arya_chudidhar_0001")
