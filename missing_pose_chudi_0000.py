...
dest='/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset/Datasets/Absdiff_base_dir/Arya_chudi_missingpose/Arya_chudi_0000/'
...
output_df=pd.pd.DataFrame(top_list,columns=['path','Aug','class_name','Misssing_image','No_of_hands']) 
print(lst[0])
output_df=pd.DataFrame(lst,columns=['Aug','class_name','count'])
print(output_df.head())
output_df.to_csv('/mnt/fs/Splitted_data/samp_1/chudi_hand_0000.csv', index=False)
