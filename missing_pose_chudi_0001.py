...
path = '/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset/Datasets/Absdiff_base_dir/segmented_dataset/Arya_chudidhar_augs_0001/'
#The immediate file path

directory_contents = os.listdir(path)
print(directory_contents)
dest='/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset/Datasets/Absdiff_base_dir/Arya_chudi_missingpose/Arya_chudi_0001/'
...
output_df.to_csv('/mnt/fs/Splitted_data/samp_1/chudi_hand_0001.csv', index=False)
