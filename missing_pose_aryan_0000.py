...
dest='/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset/Datasets/Absdiff_base_dir/Aryan_missingpose/Aryan_0000/'
...
for i in range (0,len(directory_contents)):
    ...
    for j in range (0,len(class_name)):
        ...
        for k in range (0,len(img_name)):
            ...
            with open('/mnt/fs/Splitted_data/samp_1/aryan_hands_00.csv', 'a',newline='') as f:
