...
dest='/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset/Datasets/Absdiff_base_dir/Arya_chudi_missingpose/Arya_chudi_0002/'
...
output_df.to_csv('/mnt/fs/Splitted_data/samp_1/chudi_hand_0002.csv', index=False)
print("$$$Done With Arya_chudi_0002")
