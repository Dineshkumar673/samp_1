...
dest='/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset/Datasets/Absdiff_base_dir/Aryan_missingpose/Aryan_0003/'
...
output_df.to_csv('/mnt/fs/Splitted_data/samp_1/aryan_hand_0003.csv', index=False)                
