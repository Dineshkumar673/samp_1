...
import os
import shutil
dir_name='/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset/Datasets/Absdiff_base_dir/segmented_dataset/Arya_suit_augs_0001/'
...
dest='/mnt/fs/Splitted_data/Arya_suit_0001'
for i in dir_val:
    os.mkdir(dest+'/'+i+'/')
