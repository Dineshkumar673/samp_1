...
path = '/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset/Datasets/Absdiff_base_dir/segmented_dataset/Arya_suit_augs_0004/'
#The immediate file path

directory_contents = os.listdir(path)
print(directory_contents)
dest='/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset/Datasets/Absdiff_base_dir/Arya_suit_missingpose/Arya_suit_0004/'
...
output_df.to_csv('/mnt/fs/Splitted_data/samp_1/suit_hand_0004.csv', index=False)
print("$$$Done With Arya_suit_0004")
